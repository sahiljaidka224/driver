...
const non_blocking_json_1 = require("non-blocking-json");
...
class Devtools {
    constructor(name) {
        ...
        this.flushBuffer = () => tslib_1.__awaiter(this, void 0, void 0, function* () {
    ...
    send(message) {
        ...
        non_blocking_json_1.stringify(message, (payload) => {
            this.sendMessage(payload);
        }, function (_, value) {
            ...
            if (value && value[rehydrate_1.SERIALIZE]) {
                return {
                    __CLASS__: true,
