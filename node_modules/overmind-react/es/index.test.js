import { Overmind, createOvermindMock } from 'overmind';
import * as React from 'react';
import * as renderer from 'react-test-renderer';
import { Provider, createConnect, createHook } from './';
describe('React', () => {
    test('should connect state and actions to stateless components', () => {
        ...
        const tree = renderer
            .create(React.createElement(Provider, { value: app },
    ...
    test('should allow using mocked Overmind', () => {
        ...
        const tree = renderer
            .create(React.createElement(Provider, { value: mock },
            React.createElement(FooComponent, null)))
            .toJSON();
        expect(renderCount).toBe(1);
        expect(tree).toMatchSnapshot();
